...
description: "聚合 Claude Code 与 Psmux 的工具教程，覆盖安装、工作流、快捷键与高频配置。"
---

# Tools Tutorial

> 本页将常用开发工具教程集中到一个入口，当前包含 Claude Code 与 Psmux 两部分，便于统一查阅安装方法、工作流模式与高频操作。

## 本页结构

- [Claude Code 程序员效率手册](#claude-code-程序员效率手册)
- [Psmux 初学者教程](#psmux-初学者教程)
